          ...
          >
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
              <div className="bg-spruce-soft rounded-lg p-3">
                <p className="text-ink-muted text-xs">On time</p>
                <p className="text-spruce-deep mt-1 text-xl font-semibold">
                  {report.onTimeRate}%
                </p>
              </div>
              <div className="bg-spruce-soft rounded-lg p-3">
                <p className="text-ink-muted text-xs">Current streak</p>
                <p className="text-spruce-deep mt-1 text-xl font-semibold">
                  {report.streak} day{report.streak === 1 ? "" : "s"}
                </p>
              </div>
              <div className="bg-spruce-soft rounded-lg p-3">
                <p className="text-ink-muted text-xs">Points</p>
                <p className="text-spruce-deep mt-1 text-xl font-semibold">
                  {report.points}
                </p>
              </div>
                ...
                <div className="border-line mt-3 border-t pt-3">
                  {report.missedRejected.length > 0 ? (
                        ...
                        >
                          ...
                          {instance.parent_note && (
                            <p className="text-ink-muted mt-2 text-sm">
                              Parent note: {instance.parent_note}
                            </p>
                          )}
                        </li>
                      ))}
                    ...
                    <p className="text-ink-muted text-sm">
                      No missed or rejected chores in this reporting period.
                    </p>
                  )}
                </div>
              </details>
